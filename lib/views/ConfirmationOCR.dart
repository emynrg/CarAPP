...
import 'package:netcars/views/DetailCarWithTF.dart';
...
class ConfirmationOCRPage extends StatefulWidget {
  final String? vin;
  final String? model;
  final List<dynamic>? carActions;
  final List<Map<String, dynamic>>? actionPerforms;

  const ConfirmationOCRPage(
      {super.key, this.vin, this.model, this.carActions, this.actionPerforms});

  @override
  State<ConfirmationOCRPage> createState() => _ConfirmationOCRPageState();
}

class _ConfirmationOCRPageState extends State<ConfirmationOCRPage> {
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: TextField(
                    //controller: TextEditingController(text: widget.vin),
                    ...
                    style: TextStyle(fontFamily: 'PoppinsSemiBold', fontSize: 15.sp),
                  ),
                ),
                 SizedBox(
                width: MediaQuery.of(context).size.width / 16,
                    ...
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          title: Text('Erreur'),
                          content: Text(
                              'Erreur lors de la récupération des détails de la voiture. Veuillez réessayer.'),
                          actions: <Widget>[
                            TextButton(
                              onPressed: () {
